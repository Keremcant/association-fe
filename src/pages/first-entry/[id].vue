...
const passwordValidator = v => v.length >= 6 || 'Password must be at least 6 characters'
const matchPasswordValidator = v => v === credentials.value.newPassword || 'Passwords do not match'
